...
public class AddressSeeker {
    ...
    public static void main(String[] args) {
		AddressSeeker seeker = new AddressSeeker();
		try {
			List<SimpleFeature> geocode = seeker.geocode("1600 Pennsylvania Av, Washington, DC");
			for (SimpleFeature feature : geocode) {
				System.out.println(((Point) feature.getDefaultGeometry())
						.toString() + " " + feature.getAttribute("state") + "," + feature.getAttribute("type"));
			}
		} catch (IOException e) {
